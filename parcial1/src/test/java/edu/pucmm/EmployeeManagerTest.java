...
public class EmployeeManagerTest {
    ...
    public void testAddEmployee() {
      ...
      assertEquals(2,employeeManager.getEmployees().size());  // - Verificar que el número total de empleados ahora es 2.
         assertTrue(employeeManager.getEmployees().contains(employee2)); // - Verificar que employee2 está en la lista de empleados.
    }

    @Test
    public void testRemoveEmployee() {
        // TODO: Eliminar employee1 del employeeManager y verificar que se eliminó correctamente.
        employeeManager.addEmployee(employee2); // - Agregar employee2 al employeeManager.
        employeeManager.removeEmployee(employee1); // - Eliminar employee1 del employeeManager.
        assertEquals(1,employeeManager.getEmployees().size()); // - Verificar que el número total de empleados ahora es 1.
        assertFalse(employeeManager.getEmployees().contains(employee1)); // - Verificar que employee1 ya no está en la lista de empleados.
        assertTrue(true);
    }
    ...
    public void testCalculateTotalSalary() {
        ...
        employeeManager.addEmployee(employee2); // - Agregar employee2 al employeeManager.
       assertTrue(employeeManager.calculateTotalSalary() == (employee1.getSalary() + employee2.getSalary())); // - Verificar que el salario total es la suma de los salarios de employee1 y employee2.
    }
    ...
    public void testUpdateEmployeeSalaryValid() {
       ...
       employee1.setSalary(45000); // - Actualizar el salario de employee1 a 45000.
       assertEquals(45000, employee1.getSalary()); // - Verificar que el salario de employee1 ahora es 45000.
    }
    ...
    public void testUpdateEmployeeSalaryInvalid() {
       ...
       assertThrows(InvalidSalaryException.class,() -> employeeManager.updateEmployeeSalary(employee1,60000 )); // - Verificar que se lanza una InvalidSalaryException.
    }
    ...
    public void testUpdateEmployeePositionValid() {
       ...
       employeeManager.addEmployee(employee2); // - Agregar employee2 al employeeManager.
       employeeManager.updateEmployeePosition(employee2,seniorDeveloper); // - Actualizar la posición de employee2 a seniorDeveloper.
       assertEquals(seniorDeveloper,employee2.getPosition()); // - Verificar que la posición de employee2 ahora es seniorDeveloper.
    }
    ...
    public void testAddEmployeeWithInvalidSalary() {
        ...
        // - Verificar que se lanza una InvalidSalaryException al agregar este empleado.
        assertThrows(InvalidSalaryException.class,() -> employeeManager.addEmployee(new Employee("10", "Jt", juniorDeveloper, 60000)));
        assertThrows(InvalidSalaryException.class,() -> employeeManager.addEmployee(new Employee("11", "ww", seniorDeveloper, 40000)));
    }
